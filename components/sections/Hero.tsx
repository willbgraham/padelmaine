  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-28 md:pt-24"
      >
        <motion.p
        ...
        <motion.h1
          variants={heroFadeVariants}
          className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-cream leading-[0.95] tracking-tight"
        >
